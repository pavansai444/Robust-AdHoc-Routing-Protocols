...
set tracefd       [open aodv40.tr w]
set windowVsTime2 [open aodv40.tr w] 
set namtrace      [open aodv40.nam w]     
expr { srand(999) }
...
$ns attach-agent $node_(31) $tcp8
$ns attach-agent $node_(35) $sink8
...
$ns attach-agent $node_(38) $tcp9
$ns attach-agent $node_(1) $sink9
$ns connect $tcp9 $sink9
set ftp9 [new Application/FTP]
$ftp9 attach-agent $tcp9
$ns at 1.1 "$ftp9 start"
