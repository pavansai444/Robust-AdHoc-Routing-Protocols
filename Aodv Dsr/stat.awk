BEGIN {
  ...
  if (( $1 == "s") &&  ( $7 == "tcp" || $7 =="ack"||$7=="cbr" ) && ( $4=="AGT" )) {  
    sends++;
    if(pacMax < packet_id )
      pacMax = packet_id;
    if(time<startt)
  ...
  if (( $1 == "r") &&  ( $7 == "tcp" || $7 =="ack" ||$7=="cbr") && ( $4=="AGT" ))   {
      recvs++;
      if($7=="tcp"){
        recv_size++;
  ...
  if ((( $1 == "r") &&  ( $7 == "tcp" || $7 == "ack" ) && ( $4=="AGT" ))||((( $1 == "r") &&  ( $7 == "cbr" || $7 == "ack" ) && ( $4=="AGT" )))) { end_time[packet_id] = time;  }
       else {  end_time[packet_id] = -1;  }
  # CALCULATE TOTAL AODV OVERHEAD
  if (($1 == "s" || $1 == "f" || $1="r") && $4 == "RTR" && ($7 =="undefined" ||$7 =="AOMDV"||$7=="AODV"||$7=="DSR")) routing_packets++;
  # DROPPED PACKETS
  ...
  {    sum += packet_duration;
	...
	print("max energy consumed",maxenergy)
     ...
     print("No. of dropped packets = ",sends-recvs);
     print("packet drop % = ",((sends-recvs)/sends*100));
